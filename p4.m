...
sol = dde23(f,48,[20,80,1,1,50,10],[0,500]);
sol.x=sol.x/6;
...
plot(sol.x,sol.y(5,:), 'DisplayName', 'nematode population',LineWidth=1.5);
plot(sol.x,sol.y(6,:), 'DisplayName', 'Fish Lice population',LineWidth=1.5);
legend('show');
hold off
